"""
Product agent for handling product-related operations.
"""
...
class ProductAgent(BaseAgent):
    """Agent responsible for product-related operations."""
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Process product data and generate/update product profile.
        
        Args:
            data: Dictionary containing product information
            
        Returns:
            Dictionary containing the generated/updated product profile
        """
        try:
            # Generate product story using Gemini
            story = await self.gemini_service.generate_product_story(data)
    ...
    async def explain(self, data: Dict[str, Any]) -> str:
        """
        Generate an explanation for the product profile.
